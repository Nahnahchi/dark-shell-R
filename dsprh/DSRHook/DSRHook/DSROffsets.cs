...
namespace DarkShellRemastered
{
    internal class DSROffsets
    {
        ...
        public enum GameMan
        {
            ...
            IsDisableAllAreaEvent = 0xD40,
            IsDisableAllAreaMap = 0xD41,
            IsDisableAllAreaObj = 0xD42,
            IsEnableAllAreaObj = 0xD43,
            IsEnableAllAreaObjBreak = 0xD44,
            IsDisableAllAreaHiHit = 0xD45,
            IsEnableAllAreaLoHit = 0xD46,
            IsDisableAllAreaSfx = 0xD47,
            IsDisableAllAreaSound = 0xD48,
            IsObjBreakRecordMode = 0xD49,
            IsAuthoMapWarpMode = 0xD4A,
            IsChrNpCWanderTest = 0xD4B,
            IsDbgChrAllDead = 0xD4C,
            bRequestToEnding = 0xB48,
            IsOnlineMode = 0xB7D,
        }
