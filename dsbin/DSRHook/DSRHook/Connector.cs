...
namespace CheatEngine
{
    ...
    class CheatEngineLibrary
    {
        ...
        // Static invocations.
        [DllImport("kernel32.dll", EntryPoint = "LoadLibraryW", SetLastError = true, CharSet = CharSet.Unicode, CallingConvention = CallingConvention.Winapi)]
 ...
 bool unicode, bool casesensitive, bool percentage, bool compareToSavedScan, [MarshalAs(UnmanagedType.BStr)] string savedscanname);
        ...
        public void loadEngine()
        {
            ...
            {
                libInst = LoadLibraryW("dsbin/ce-lib64.dll");
            }
            else
            {
                libInst = LoadLibrary("dsbin/ce-lib32.dll");
            }
            ...
            //else Console.WriteLine("error, can't load the library: " + GetLastError());
